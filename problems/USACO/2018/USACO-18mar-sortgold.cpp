/*
Observe that for some fixed division point the process takes the number of out of place 
values to fix, so find the maximum and it will fix for all division points. Use BIT to simulate.
*/
